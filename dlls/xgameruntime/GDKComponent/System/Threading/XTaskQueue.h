...
class __declspec(uuid("4529CADF-1BA0-4038-A854-2C0CA26396CB")) TaskQueuePortImpl : public ITaskQueuePort
{
public:
...
class __declspec(uuid("AFAF0302-AEBB-491A-946F-BFB283496E7A")) TaskQueuePortContextImpl : public ITaskQueuePortContext
{
public:
...
class __declspec(uuid("D63140D8-9A27-4951-B446-FB8639490A9B")) TaskQueueImpl : public ITaskQueue
#ifdef SUSPEND_API
